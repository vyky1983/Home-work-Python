...
def ls_menu():
    while True:
        ...
        if n == 1:
            ...
            lg.logging.info('Выбран пункт №6')
            ...
            if change == 1:
                ...
                lg.logging.info('Недопустимые значения!')
                print(
                    '\nНе корректные данные.\nВведите цифру, соответствующую пункту меню.')

        elif n == 7:
            lg.logging.info('Выбран пункт №7')
            print('1. Найти номер по фамилии.')
            print('2. Найти номер по имени.')
            print('3. Поиск по номеру телефона.')
            ...
            lg.logging.info('Недопустимые значения!: {n}')
            print(
                '\nНе корректные данные.\nВведите цифру, соответствующую пункту меню.')
...
def сhecking_the_number(arg):
    while arg.isdigit() != True:
        lg.logging.info('Недопустимые значения!: {arg}')
        print('\nВы ввели не число.')
